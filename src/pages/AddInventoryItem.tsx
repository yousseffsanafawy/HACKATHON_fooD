...
export default function AddInventoryItem() {
  ...
  const categories: Category[] = ['Vegetables', 'Fruits', 'Dairy', 'Meat', 'Pantry', 'Beverages'];
    ...
    <div className="bg-white min-h-screen pb-24">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-slate-100 pb-8">
        <button 
          onClick={handleSave} 
          disabled={!name}
          className="w-full bg-primary hover:bg-primary-hover disabled:bg-slate-300 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl shadow-lg shadow-primary/20 transition-all"
        >
          Save Item
        </button>
      </div>
